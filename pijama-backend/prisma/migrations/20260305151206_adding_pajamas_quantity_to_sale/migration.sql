/*
  ...
  - Added the required column `totalPajamas` to the `sales` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "totalPajamas" INTEGER NOT NULL;
